...
const Homepage = () => {
  ...
  const primaryBg = isDark ? "bg-zinc-800" : "bg-gradient-to-br from-blue-700 to-blue-500 text-white"; // Attractive blue gradient

  const secondaryBtn = "bg-green-500 hover:bg-green-600 text-white shadow-xl hover:shadow-2xl transition duration-300";
        ...
        <section className={`py-28 lg:py-40 text-center ${primaryBg}`}>
          <div className="max-w-5xl mx-auto px-4">
            <h1 className="text-5xl lg:text-6xl font-extrabold mb-6 tracking-tight">
              Track Your Impact. <br className="hidden sm:inline" /> Trust Every Transaction.
            </h1>
            <p className="text-xl lg:text-2xl mb-10 max-w-3xl mx-auto opacity-90 font-light">
              We leverage <span className="font-bold">Blockchain technology</span> to provide complete transparency on
              where and how your donation is used, from click to impact.
            </p>
